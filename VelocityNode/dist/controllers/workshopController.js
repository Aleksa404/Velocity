...
exports.unenrollFromWorkshop = exports.getUserEnrollments = exports.denyEnrollment = exports.approveEnrollment = exports.getWorkshopEnrollments = exports.enrollInWorkshop = exports.deleteWorkshop = exports.updateWorkshop = exports.getWorkshopById = exports.getAllWorkshops = exports.createWorkshop = void 0;
...
const getAllWorkshops = async (req, res) => {
    try {
        ...
        if (currentUserId) {
            const workshopsWithStatus = await Promise.all(workshops.map(async (workshop) => {
...
exports.enrollInWorkshop = enrollInWorkshop;
// Get workshop enrollments (owner only)
const getWorkshopEnrollments = async (req, res) => {
    try {
        const { id: workshopId } = req.params;
        const { id: userId } = req.user;
        const workshop = await prisma.workshop.findUnique({
...
exports.getWorkshopEnrollments = getWorkshopEnrollments;
// Approve enrollment
...
exports.denyEnrollment = denyEnrollment;
...
const unenrollFromWorkshop = async (req, res) => {
    try {
        const { id: workshopId } = req.params;
        const { id: userId } = req.user;
        const enrollment = await prisma.workshopEnrollment.findUnique({
...
exports.unenrollFromWorkshop = unenrollFromWorkshop;
